...
labor <- 
  data.frame(
    ...
    Num_unemployed <- Unemployment$Num_unemployed,
    Unemployment_diff <- Unemployment$Unemployment_diff,
    Temp_labor <- Temp_labor$Value,
    Temp_labor_diff <- Temp_labor$temp_labor_diff
  ) %>% 
  as_tsibble()
